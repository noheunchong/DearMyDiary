...
<!-- 부트스트랩 -->
<link href="/mydiary/resources/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
</head>
<script
	src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
<script src="/mydiary/resources/bootstrap/js/bootstrap.min.js"></script>
<body>
	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/mydiary">Dear My Diary</a>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a id="drop" class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="/mydiary/diary/shareboard"><span
							...
							<c:if test="${login != null}">
								...
								<li><a href="/mydiary/diary/list"><span
				...
				<c:if test="${login == null}">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="/mydiary/user/login"><span
				...
				<c:if test="${login != null}">
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href="/mydiary/user/logout"><span
