...
import com.diary.mydiary.domain.DiaryVO;
import com.diary.mydiary.service.DUserService;
import com.diary.mydiary.service.DiaryService;
...
public class JSONController {
	...
	public Map<String, Object> login(@RequestParam("id") String id, @RequestParam("pw") String pw) {
		...
		// 리턴 값 미리 확인
		// 1. 정상 로그인 - http://localhost:8080/mydiary/androidlogin?id=kjj8032&pw=1234
		// {"login":{"id":"kjj8032","pw":"1234","profile":null,"nickname":"강남이언니", "intro" : "소"}}
		// 2. 로그인 실패 - http://localhost:8080/mydiary/androidlogin?id=kjj8032&pw=12345
		// {"login":null}
		// 아이피 : 192.168.25.46
	}
	...
	public Map<String, Object> list(@RequestParam("id") String id) {
		...
		return map;
		// 출력 예제
		// http://localhost:8080/mydiary/androidlist?id=kjj8032
		/*
	...
	public Map<String, Object> detail(@RequestParam("no") int no, @RequestParam("id") String id) {
		...
		return map;
		// 출력 형식
		// http://localhost:8080/mydiary/androiddetail?no=115&id=kjj8032
		/*
